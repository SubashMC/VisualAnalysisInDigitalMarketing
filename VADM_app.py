...
def visualize_corr():
    corr_matrix = df[['Website Traffic','Platform', 'Conversion Rate', 'Revenue', 'Customer Acquisition Cost', 'Email Open Rate',
                        'Email Click-Through Rate']].corr()
...
def visualize_traffic():
    ...
    sns.lineplot(data=df, x='Platform', y='Website Traffic', ax=ax)
...
def visualize_conv():
    ...
    fig, ax = plt.subplots(figsize=(8, 6))
    sns.lineplot(data=df, x='Platform', y='Conversion Rate', ax=ax)
...
def visualize_revenue():
    ...
    fig, ax = plt.subplots(figsize=(8, 6))
    sns.lineplot(data=df, x='Platform', y='Revenue', ax=ax)
...
def visualize_cost():
    ...
    fig, ax = plt.subplots(figsize=(8, 6))
    sns.lineplot(data=df, x='Platform', y='Customer Acquisition Cost', ax=ax)
...
def visualize_open_rate():
    ...
    fig, ax = plt.subplots(figsize=(8, 6))
    sns.lineplot(data=df, x='Platform', y='Email Open Rate', ax=ax)
...
def visualize_click_rate():
    ...
    fig, ax = plt.subplots(figsize=(8, 6))
    sns.lineplot(data=df, x='Platform', y='Email Click-Through Rate', ax=ax)
